class FibonacciBinaryExponentiation {

    // Function to multiply two 2x2 matrices
    public static long[][] multiplyMatrices(long[][] A, long[][] B) {
        long[][] result = new long[2][2];
        // first row of A with B first column
        result[0][0] = A[0][0] * B[0][0] + A[0][1] * B[1][0];
        // first row of A with B second column
        result[0][1] = A[0][0] * B[0][1] + A[0][1] * B[1][1];
        // second row of A with B first column
        result[1][0] = A[1][0] * B[0][0] + A[1][1] * B[1][0];
        // second row of A with B second column
